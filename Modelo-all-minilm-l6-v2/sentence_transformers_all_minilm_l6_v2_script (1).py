# -*- coding: utf-8 -*-
"""sentence-transformers/all-MiniLM-L6-v2 - Script
...
# Célula para visualizar e baixar o relatório gerado
from google.colab import files
import os

# Verificar se o arquivo foi criado
if os.path.exists(OUTPUT_FILE):
    print("=== VISUALIZAR CONTEÚDO DO RELATÓRIO ===")
    print(f"Arquivo: {OUTPUT_FILE}")
    print("Tamanho:", os.path.getsize(OUTPUT_FILE), "bytes")
    print("\n" + "="*50)
    ...
    print("\n" + "="*50)
    print("Para baixar o arquivo, execute a próxima célula ou:")
    print("1. Clique no ícone de pasta no menu lateral")
    print("2. Encontre o arquivo 'padroes_arquiteturais.txt'")
    print("3. Clique com botão direito → Download")
else:
    print("Arquivo não encontrado. Execute a célula anterior primeiro.")

# Célula para baixar o arquivo diretamente
from google.colab import files
...
if os.path.exists(OUTPUT_FILE):
    ...
    print("Arquivo não encontrado. Execute a primeira célula primeiro.")